...
const MOCK_WEEKLY = [
  { day: "Mon", assessments: 4 },
  { day: "Tue", assessments: 7 },
  { day: "Wed", assessments: 5 },
  { day: "Thu", assessments: 9 },
  { day: "Fri", assessments: 6 },
  { day: "Sat", assessments: 3 },
  { day: "Sun", assessments: 2 },
];
    ...
    <PageLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
        ...
        <StatCard
          ...
          value={stats?.assessmentsToday ?? 0}
          ...
          <ResponsiveContainer width="100%" height={160}>
            <BarChart data={MOCK_WEEKLY} barSize={22}>
              ...
              <Tooltip
                ...
                cursor={{ fill: "rgba(57,217,138,0.05)" }}
              />
        ...
        <div className="lg:col-span-2 card p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="text-accent-green text-xs flex items-center gap-1 hover:underline"
            >
                ...
                >
                  <div className="min-w-0 flex-1 mr-3">
                    ...
                    <p className="text-text-muted text-xs truncate">
                      {a.patient?.patientId} • {formatDateTime(a.submittedAt)}
                    </p>
                  </div>
                  {a.prediction ? (
                    <RiskBadge category={a.prediction.riskCategory} />
                  ) : (
